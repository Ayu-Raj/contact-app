    ...
    render() {
        return (
            ...
            <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                ...
                </a><a class="btn btn-primary active btn-icon-split" role="button"><span class="text-white-50 icon"><i class="fas fa-envelope"></i></span><span class="text-white text">Send OTP</span></a>
